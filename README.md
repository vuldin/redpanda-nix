...
Compliance artifacts (SBOM, provenance, vulnerability scan) are generated by `scripts/update.sh` and attached to [GitHub Releases](https://github.com/vuldin/redpanda-nix/releases).
